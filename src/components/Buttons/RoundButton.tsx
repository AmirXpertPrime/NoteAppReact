...
const RoundButton = ({ submitBtnClicked, buttonText }: RoundButtonProps) => {
    return (
        <div>

            <button className=" w-full bg-blue-600 border-blue-600 text-white rounded-md inline-flex items-center justify-center py-3 px-7 hover:bg-blue-700 hover:border-blue-700" onClick={() => { submitBtnClicked() }}>
                <span className="mr-2">
                    <svg
                        width={20}
                        height={20}
